...
let Issues: Collection<Issue>; // Added Issues collection variable
...
if (process.env.IS_BUILD !== "true") {
    ...
    Issues = db.collection<Issue>("issues"); // Initialize Issues collection
}
...
export {
    ...
    Challenges,
    Proposals,
    Issues, // Export Issues collection
};
