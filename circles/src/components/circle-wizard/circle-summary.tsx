...
export default function CircleSummary({ circleData }: CircleSummaryProps) {
    ...
    return (
        <div className="sticky top-0 w-[240px] space-y-6 rounded-xl bg-white p-4 shadow-sm">
            ...
            <div className="relative -mt-12 flex flex-col items-center">
                ...
                <h3 className="mt-2 text-center text-lg font-semibold">{name || "Circle Name"}</h3>
            ...
            {description && (
                <div className="space-y-1">
                    <h4 className="text-xs font-semibold uppercase text-gray-500">About</h4>
            ...
            {mission && (
                <div className="space-y-1">
                    <h4 className="text-xs font-semibold uppercase text-gray-500">Mission</h4>
            ...
            {selectedCauses.length > 0 && (
                <div className="space-y-1">
                    <h4 className="text-xs font-semibold uppercase text-gray-500">Causes</h4>
