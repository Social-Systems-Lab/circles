...
export default function LocationStep({ circleData, setCircleData, nextStep, prevStep }: CircleWizardStepProps) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold">{circleData.isProjectsPage ? "Project" : "Community"} Location</h2>
                <p className="text-gray-500">
                    Add a location to help people find your {circleData.isProjectsPage ? "project" : "community"} and
            ...
            <Card>
                <CardContent className="pt-6">
                    <Label>{circleData.isProjectsPage ? "Project" : "Community"} Location</Label>
