...
Phase 3B1b source/shadow/share/preview authorization and Phase 3B1c Post interaction/notification hardening remain incomplete. Other derived-resource authorization, public attachment URL/private upload selection, chat, notification, and admission surfaces also remain release blockers, so Secret Circles must not be enabled in production yet.
